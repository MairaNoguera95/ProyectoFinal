...
fetch(
  // Obtenemos los datos de la planilla, de la hoja hojaGastos, columnas A y E desde la segunda fila
  `https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/hojaGastos!A2:E`,
  {
         headers: {
